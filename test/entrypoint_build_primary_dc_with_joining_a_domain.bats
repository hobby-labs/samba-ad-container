...
@test '#build_primary_dc_with_joining_a_domain should return 0 if all instructions were succeeded' {
    run build_primary_dc_with_joining_a_domain; command echo "$output"
...
@test '#build_primary_dc_with_joining_a_domain should return 1 if samba-tool domain join has failed' {
...
@test '#build_primary_dc_with_joining_a_domain should return 1 if samba-tool fsmo transfer has failed' {
    stub_and_eval samba-tool '{
