...
@test '#build_primary_dc should return 1 if pre_provisioning was failed' {
...
@test '#build_primary_dc should return 1 if samba-tool was failed' {
...
@test '#build_primary_dc should return 1 if post_provisioning was failed' {
